...
-- ---- public: PRIVACY_POLICY / ja / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
...
-- ---- public: PRIVACY_POLICY / en / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'PRIVACY_POLICY'::varchar AS code,
    'en'::varchar AS language,
...
-- ---- public: PRIVACY_POLICY / zh / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'PRIVACY_POLICY'::varchar AS code,
    'zh'::varchar AS language,
...
-- ---- public: THIRD_PARTY_SDK / ja / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
...
-- ---- public: THIRD_PARTY_SDK / en / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'THIRD_PARTY_SDK'::varchar AS code,
    'en'::varchar AS language,
...
-- ---- public: THIRD_PARTY_SDK / zh / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'THIRD_PARTY_SDK'::varchar AS code,
    'zh'::varchar AS language,
...
-- ---- crawl: THIRD_PARTY_SDK / ja / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'THIRD_PARTY_SDK'::varchar AS code,
    'ja'::varchar AS language,
...
-- ---- crawl: THIRD_PARTY_SDK / en / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'THIRD_PARTY_SDK'::varchar AS code,
    'en'::varchar AS language,
...
-- ---- crawl: THIRD_PARTY_SDK / zh / 1.2.0 -----------------------------------
WITH new_row AS (
  SELECT
    'THIRD_PARTY_SDK'::varchar AS code,
    'zh'::varchar AS language,
