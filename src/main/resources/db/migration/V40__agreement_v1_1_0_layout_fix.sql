...
$body$,
 ...
 WHERE code = 'USER_TERMS'
   AND language = 'ja'
   AND version = '1.1.0'
   AND deleted = 0;

-- ---- public: USER_TERMS / en -------------------------------------------
UPDATE public.agreement
   SET content = $body$
# {{APP_NAME}} User Terms
...
$body$,
       update_time = CURRENT_TIMESTAMP
 WHERE code = 'THIRD_PARTY_SDK'
   AND language = 'ja'
   AND version = '1.1.0'
   AND deleted = 0;

-- ---- public: THIRD_PARTY_SDK / en -------------------------------------------
UPDATE public.agreement
   SET content = $body$
